...
class SmsPreviewResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmsPreviewResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SmsPreviewResponse:
        """Create an instance of SmsPreviewResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SmsPreviewResponse.parse_obj(obj)

        _obj = SmsPreviewResponse.parse_obj(
            {
