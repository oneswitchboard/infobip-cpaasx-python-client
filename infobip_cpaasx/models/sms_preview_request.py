...
class SmsPreviewRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmsPreviewRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SmsPreviewRequest:
        """Create an instance of SmsPreviewRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SmsPreviewRequest.parse_obj(obj)

        _obj = SmsPreviewRequest.parse_obj(
            {
                "text": obj.get("text"),
