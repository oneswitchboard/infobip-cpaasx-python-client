...
class SmsTextualMessage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmsTextualMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SmsTextualMessage:
        """Create an instance of SmsTextualMessage from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SmsTextualMessage.parse_obj(obj)

        _obj = SmsTextualMessage.parse_obj(
            {
                ...
                "destinations": [
                    SmsDestination.from_dict(_item) for _item in obj.get("destinations")
                ]
