...
class SmsAdvancedTextualRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmsAdvancedTextualRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SmsAdvancedTextualRequest:
        """Create an instance of SmsAdvancedTextualRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SmsAdvancedTextualRequest.parse_obj(obj)

        _obj = SmsAdvancedTextualRequest.parse_obj(
            {
                "bulk_id": obj.get("bulkId"),
                "messages": [
                    SmsTextualMessage.from_dict(_item) for _item in obj.get("messages")
                ]
